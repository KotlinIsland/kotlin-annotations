...
annotation class Language(
         ...
         * - "HTML" - HTML
         * - "XML" - XML
         * - "RegExp" - Regular expression supported by Kotlin [Regex]
         */
         ...
         *
         * `fun methodProcessor(@Language(value="JAVA", prefix="class X {", suffix="}")`.
         */
