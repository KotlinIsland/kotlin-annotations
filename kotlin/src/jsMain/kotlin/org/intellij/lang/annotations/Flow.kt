...
actual annotation class Flow(
         ...
         *
         */
        actual val source: String = DEFAULT_SOURCE,
        /**
         ...
         * ArrayList(<pre><tt>`@Flow(sourceIsContainer=true, targetIsContainer=true) Collection<? extends E> collection `</tt></pre>) <br></br>
         * By default it's false.
         */
        actual val sourceIsContainer: Boolean = false,
        /**
         ...
         *
         */
        actual val target: String = DEFAULT_TARGET,
        /**
         ...
         * By default it's false.
         */
        actual val targetIsContainer: Boolean = false) {
    companion object {
